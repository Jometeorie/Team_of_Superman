...
public class Book{
    ...
    public static Boolean EditLocation(String location,String book_id){
        JdbcTemplate template=new JdbcTemplate(JdbcUtils.getDataSource());
     ...
     * 编辑名称
     * */
    public static Boolean EditBook_Name(String book_name,String book_id){
        JdbcTemplate template=new JdbcTemplate(JdbcUtils.getDataSource());
     ...
     * 编辑书籍价格
     * */
    public static Boolean EditPrice(BigDecimal price, String Book_id){
        JdbcTemplate template=new JdbcTemplate(JdbcUtils.getDataSource());
     ...
     * 编辑书籍类别
     * */
    public static Boolean EditCategory(String category, String book_id){
        JdbcTemplate template=new JdbcTemplate(JdbcUtils.getDataSource());
    ...
    public static boolean DeleteBook(String Libr_ID,String Book_ID,String Book_Name) {
        Connection con=null;
    ...
    public static boolean InsertBookDeleted(String Libr_ID,String Book_ID,String Book_Name) {
        Connection con =null;
        PreparedStatement stmt=null;
        ResultSet rs=null;
        try {
