...
'<button id="bAcep" type="button" class="btn btn-sm btn-default" style="display:none;" onclick="modify(); rowAcep(this);">' + 
...
function modify() {
    var jumpHref = 'LibrarianManagement/Modify';
    ...
    window.location.href=jumpHref + "/" + id + "/" + name + "/" + password;
}

function delete_process() {
    var jumpHref = 'LibrarianManagement/Delete';
    var id = document.getElementById("edit0").value;
